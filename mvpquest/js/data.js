...
const TILE_ATLAS = {
    ...
    [T.WALL_T]:   { s:'city', c:10, r:0  },
    [T.WALL_F]:   { s:'city', c:10, r:1  },
    [T.WALL_TL]:  { s:'city', c:8,  r:0  },
    [T.WALL_TR]:  { s:'city', c:9,  r:0  },
    [T.WALL_L]:   { s:'city', c:11, r:0  },
    [T.WALL_R]:   { s:'city', c:11, r:1  },
    [T.WALL_BL]:  { s:'city', c:8,  r:1  },
    [T.WALL_B]:   { s:'city', c:10, r:1  },
    [T.WALL_BR]:  { s:'city', c:9,  r:1  },
